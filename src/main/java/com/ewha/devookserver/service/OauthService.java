...
public class OauthService {
    ...
    public LoginResponse login(String providerName, String code) {
        ...
        if(memberRepository.existsMemberByOauthId(userProfile.getOauthId())){
            existUser=true;
        }
    ...
    private Member saveOrUpdate(UserProfile userProfile, String refreshToken) {
        ...
        Member member = memberRepository.findByOauthId(userProfile.getOauthId())
                .map(entity -> entity.update(userProfile.getName(), userProfile.getEmail(), userProfile.getImageUrl(), refreshToken))
